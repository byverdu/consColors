...
function consColors( opts ) {
  ...
  var innerOpts = opts ? opts : {};
  if (Object.keys(opts).indexOf( 'type' ) !== -1 || Object.keys(opts).indexOf( 'invert' ) !== -1 ) {
    console.log('\x1b[31m','pipe is not a valid property, it should be type or invert', '\x1b[0m' )
  }
